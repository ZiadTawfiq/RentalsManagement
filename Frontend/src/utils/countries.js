export const countries = [
    ...
    { name: "Heard Island and Mcdonald Islands", code: "HM", dialCode: "+", flag: "🇭🇲" },
    ...
    { name: "Serbia and Montenegro", code: "CS", dialCode: "+381", flag: "🇨🇸" },
    ...
    { name: "South Georgia and the South Sandwich Islands", code: "GS", dialCode: "+", flag: "🇬🇸" },
    ...
    { name: "United States Minor Outlying Islands", code: "UM", dialCode: "+", flag: "🇺🇲" },
