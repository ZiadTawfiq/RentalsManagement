...
namespace RentalManagement.Migrations
{
    ...
    [Migration("20260307000425_ForceSyncSalaryFields_v3")]
    partial class ForceSyncSalaryFields_v3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentalManagement.Entities.AssetTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalManagement.Entities.Campain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalManagement.Entities.EarningsHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EmployeeFinancialAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmployeeFinancialAccountId");

                    b.HasIndex("PerformedById");

                    b.ToTable("EarningsHistories");
                });

            modelBuilder.Entity("RentalManagement.Entities.EmployeeFinancialAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("RemainingBonusBalance")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RemainingCommission")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RemainingMonthlySalary")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SalaryForCurrentMonth")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalBonusBalance")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("EmployeeFinancialAccounts");
                });

            modelBuilder.Entity("RentalManagement.Entities.EmployeeTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rental", b =>
                {
                    b.HasOne("RentalManagement.Entities.ApplicationUser", "CreatedByEmployee")
                        .WithMany()
                    ...
                    b.HasOne("RentalManagement.Entities.Campain", "campain")
                        .WithMany()
            ...
            modelBuilder.Entity("RentalManagement.Entities.AssetTransaction", b =>
                {
                    b.HasOne("RentalManagement.Entities.Asset", "Asset")
            ...
            modelBuilder.Entity("RentalManagement.Entities.EarningsHistory", b =>
                {
                    b.HasOne("RentalManagement.Entities.EmployeeFinancialAccount", "EmployeeFinancialAccount")
                        .WithMany()
                        .HasForeignKey("EmployeeFinancialAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("EmployeeFinancialAccount");
